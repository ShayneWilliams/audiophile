...
export default function Footer() {
  return (
    <footer className="bg-black w-[100vw]  text-white text-center md:text-left lg:align-center absolute left-0 ">
      <div className="w-11/12 m-auto max-w-[1110px] lg:w-3/4 ">
        <div className="bg-peach w-[101px] h-[4px] m-auto md:m-0" />
        <div className="flex flex-col lg:flex-row lg:justify-between md:mb-[32px]">
          <div className="text-white mt-[52px] h-[25px] w-[143px] m-auto md:ml-0">
        ...
        <p className=" mb-[48px] opacity-50">
        ...
        <div className="flex flex-col gap-[48px] pb-[38px] w-full md:relative ">
          <p className="opacity-50">Copyright 2022. All Rights Reserved</p>
          <div className="flex justify-between w-[104px] m-auto md:absolute md:right-0">
            <Link href="/">
              <a>
                <Image
                  width="24px"
