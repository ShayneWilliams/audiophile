  ...
  return (
    <>
      <div className="bg-black fixed w-full z-50 ">
        <div className="w-11/12 h-[90px] grid grid-flow-col  content-center justify-between m-auto max-w-[1110px]">
        ...
        <div className="w-full m-auto bg-white">
          <div className="w-11/12 m-auto">
            {hamburgerActive && <div className='bg-[#a5a5a580] w-[100vw] h-[100vh] absolute top-[90px] left-0 '>
