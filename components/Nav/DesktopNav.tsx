...
export default function DesktopNav() {
  ...
  const cartHandler = () => {
    if (cart.length > 0) setVisible(!visible);
  };
  return (
    <>
      <div className="bg-black fixed w-full z-50 ">
        <div className="w-11/12 h-[90px] grid grid-flow-col  content-center justify-between m-auto max-w-[1110px] m-auto max-w-[1110px] lg:w-3/4">
          <Link href="/">
            <svg
          ...
          <div className="flex w-[430px] justify-between font-bold">
            <div>
              <Link href="/">
                <a className="hover:text-peach">HOME</a>
              </Link>
            </div>
            <div>
              <a className="hover:text-peach">
        ...
        <div className="w-full m-auto bg-white">
          <div className="w-11/12 m-auto"></div>
          {visible && <NavCart />}
        </div>
      </div>
